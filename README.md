...
- [siara-cc/sqlite_blaster](https://github.com/siara-cc/sqlite_blaster) - A library for creating huge Sqlite indexes at breakneck speeds
...
- [andjosh/staticus](https://github.com/andjosh/staticus) - A static status page running on GitHub pages (jekyll).
...
- [nikitastupin/clairvoyance](https://github.com/nikitastupin/clairvoyance) - Obtain GraphQL API Schema even when the introspection is not enabled
...
- [bazelbuild/rules_nodejs](https://github.com/bazelbuild/rules_nodejs) - JavaScript and NodeJS rules for Bazel. UNMAINTAINED (see README below).
...
- [hellof2e/quark-design](https://github.com/hellof2e/quark-design) - Next-gen frontend component library, it can be used in any framework or no framework.(下一代跨技术栈前端组件库 / 无框架组件库，技术栈无关)
