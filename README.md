...
- [farm-fe/performance-compare](https://github.com/farm-fe/performance-compare) - Performance compare for Farm, Webpack, Rspack, Turbopack and Vite
...
- [SublimeText/BetterCoffeeScript](https://github.com/SublimeText/BetterCoffeeScript) - Syntax highlighting and checking, commands, shortcuts, snippets, watched compilation and more.
...
- [nkaz001/hftbacktest](https://github.com/nkaz001/hftbacktest) - A high-frequency trading and market-making backtesting tool in Python and Rust, which accounts for limit orders, queue positions, and latencies, utilizing full tick data for trades and order books, wi
...
- [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) - Zig plugin for the asdf version manager
...
- [asdf-community/asdf-rust](https://github.com/asdf-community/asdf-rust) - Rust plugin for the asdf version manager
...
- [bazelbuild/rules_foreign_cc](https://github.com/bazelbuild/rules_foreign_cc) - Build rules for interfacing with "foreign" (non-Bazel) build systems (CMake, configure-make, GNU Make, boost, ninja, Meson)
...
- [bazelbuild/rules_nodejs](https://github.com/bazelbuild/rules_nodejs) - NodeJS toolchain for Bazel.
...
- [hellof2e/quark-design](https://github.com/hellof2e/quark-design) - Browser-native component library, framework-agnostic, base on web components.(移动端 UI 组件库，无框架，即插即用。)
...
- [jaredwray/cacheable](https://github.com/jaredwray/cacheable) - Cache module for Node.JS
...
- [livekit/node-sdks](https://github.com/livekit/node-sdks) - LiveKit real-time and server SDKs for Node.JS
...
- [jaredwray/cacheable_legacy](https://github.com/jaredwray/cacheable_legacy) - Wrap native HTTP requests with RFC compliant cache support
